...
var $author$project$Pages$Survey$init = function (initialLikeElm) {
	return {likeElm: initialLikeElm};
};
...
var $author$project$Main$SurveyRoute = {$: 'SurveyRoute'};
...
var $author$project$Main$updateUrl = function (url) {
	var _v0 = A2($elm$url$Url$Parser$parse, $author$project$Main$routeParser, url);
	if (_v0.$ === 'Just') {
		if (_v0.a.$ === 'CounterRoute') {
			var _v1 = _v0.a;
			return $author$project$Main$CounterPage(
				$author$project$Pages$Counter$init(0));
		} else {
			var _v2 = _v0.a;
			return $author$project$Main$SurveyPage(
				$author$project$Pages$Survey$init(false));
		}
	} else {
		...
		return _Utils_Tuple2(
			{
				...
				page: $author$project$Main$updateUrl(url)
			},
...
var $author$project$Main$perform = F2(
	function (navigationKey, effect) {
		switch (effect.$) {
			case 'NoEffect':
				return $elm$core$Platform$Cmd$none;
			case 'PushUrl':
				var string = effect.a;
				return A2($elm$browser$Browser$Navigation$pushUrl, navigationKey, string);
			default:
				var string = effect.a;
				return $elm$browser$Browser$Navigation$load(string);
		}
	});
		...
		switch (msg.$) {
			case 'ClickedLink':
				if (msg.a.$ === 'Internal') {
					...
					return _Utils_Tuple2(
						model,
						$author$project$Main$Load(string));
				}
			case 'ChangedUrl':
				var url = msg.a;
				return _Utils_Tuple2(
			...
			case 'GotCounterMsg':
				...
				var _v1 = model.page;
				if (_v1.$ === 'CounterPage') {
					var counterModel = _v1.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								page: $author$project$Main$CounterPage(
									A2($author$project$Pages$Counter$update, counterMsg, counterModel).a)
							}),
						$author$project$Main$NoEffect);
				} else {
			...
			default:
				...
				var _v2 = model.page;
				if (_v2.$ === 'SurveyPage') {
					var surveyModel = _v2.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								page: $author$project$Main$SurveyPage(
									A2($author$project$Pages$Survey$update, surveyMsg, surveyModel).a)
							}),
						$author$project$Main$NoEffect);
				} else {
					return _Utils_Tuple2(model, $author$project$Main$NoEffect);
...
var $author$project$Main$isLinkActive = function (_v0) {
	var route = _v0.a;
	var page = _v0.b;
	var _v1 = _Utils_Tuple2(route, page);
	if (_v1.a.$ === 'CounterRoute') {
		if (_v1.b.$ === 'CounterPage') {
			var _v2 = _v1.a;
			return true;
		} else {
			var _v3 = _v1.a;
...
var $author$project$Main$viewHeader = function (activePage) {
	return A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								$author$project$Main$isLinkActive(
									_Utils_Tuple2($author$project$Main$CounterRoute, activePage)),
								{label: 'Counter', url: '/'}),
								A2(
								$author$project$Main$navLink,
								$author$project$Main$isLinkActive(
									_Utils_Tuple2($author$project$Main$SurveyRoute, activePage)),
...
var $author$project$Main$main = function () {
	var performEffect = function (_v1) {
		var model = _v1.a;
		var effect = _v1.b;
		return _Utils_Tuple2(
			model,
			A2($author$project$Main$perform, model.navigationKey, effect));
	};
			...
			init: F3(
				function (flags, url, key) {
					return performEffect(
						A3($author$project$Main$init, flags, url, key));
				}),
